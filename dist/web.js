  ...
  return Object.keys(e).reduce((t, r) => {
    ...
    return (
      ...
      !o(s.value) ||
        ...
        (t[r].value = Object.assign({}, s.value)),
      Array.isArray(s.value) && (t[r].value = s.value.slice(0)),
      t
    );
  }, {});
}
...
function n(o, n) {
  ...
  return class extends o {
    ...
    connectedCallback() {
      if (!this.__initialized) {
        (this.__releaseCallbacks = []),
          (this.__propertyChangedCallbacks = []),
          (this.__updating = {}),
          (this.props = (function (o, s) {
            const n = e(s);
            return (
              Object.keys(s).forEach((e) => {
                const s = n[e],
                  i = o.getAttribute(s.attribute),
                  a = o[e];
                i && (s.value = s.parse ? t(i) : i),
                  null != a && (s.value = Array.isArray(a) ? a.slice(0) : a),
                  s.reflect && r(o, s.attribute, s.value),
                  Object.defineProperty(o, e, {
                    get: () => s.value,
                    set(t) {
                      var o = s.value;
                      (s.value = t), s.reflect && r(this, s.attribute, s.value);
                      for (let r = 0, s = this.__propertyChangedCallbacks.length; r < s; r++) this.__propertyChangedCallbacks[r](e, t, o);
                    },
                    enumerable: !0,
                    configurable: !0,
                  });
    ...
    attributeChangedCallback(e, r, o) {
      !this.__initialized || this.__updating[e] || ((e = this.lookupProp(e)) in n && ((null == o && !this[e]) || (this[e] = n[e].parse ? t(o) : o)));
    }
    lookupProp(e) {
...
const p = 1,
  d = 2,
  u = { owned: null, cleanups: null, context: null, owner: null };
var f = null;
let g = null,
  b = null,
  w = null,
...
function v(e, t) {
  const r = b,
    o = f,
    s = 0 === e.length,
    n = s ? u : { owned: null, cleanups: null, context: null, owner: void 0 === t ? o : t },
    i = s ? e : () => e(() => S(() => N(n)));
  (f = n), (b = null);
  try {
    return O(i, !0);
...
function x(e, t) {
  const r = { value: e, observers: null, observerSlots: null, comparator: (t = t ? Object.assign({}, c, t) : c).equals || void 0 };
  return [P.bind(r), (e) => ('function' == typeof e && (e = e(r.value)), T(r, e))];
}
function k(e, t, r) {
  E(B(e, t, !1, p));
}
function _(e, t, r) {
  (h = j), ((e = B(e, t, !1, p)).user = !0), m ? m.push(e) : E(e);
}
function C(e, t, r) {
  return (
...
function P() {
  var e;
  return (
    this.sources && this.state && (this.state === p ? E(this) : ((e = w), (w = null), O(() => z(this), !1), (w = e))),
    b &&
      ((e = this.observers ? this.observers.length : 0),
      b.sources ? (b.sources.push(this), b.sourceSlots.push(e)) : ((b.sources = [this]), (b.sourceSlots = [e])),
      this.observers
      ...
      e.observers &&
        ...
        O(() => {
          for (let o = 0; o < e.observers.length; o += 1) {
            var t = e.observers[o],
              r = g && g.running;
            r && g.disposed.has(t), (r ? t.tState : t.state) || ((t.pure ? w : m).push(t), t.observers && I(t)), r || (t.state = p);
          }
  ...
  e.fn &&
    ...
    (function (e, t, r) {
      ...
      try {
        ...
        return e.pure && ((e.state = p), e.owned && e.owned.forEach(N), (e.owned = null)), (e.updatedAt = r + 1), M(t);
      }
      (!e.updatedAt || e.updatedAt <= r) && (null != e.updatedAt && 'observers' in e ? T(e, o) : (e.value = o), (e.updatedAt = r));
    })((b = f = e), e.value, o),
    (b = r),
    (f = t));
}
function B(e, t, r, o = p, s) {
  return (
    (e = {
      fn: e,
      state: o,
    ...
    null !== f && f !== u && (f.owned ? f.owned.push(e) : (f.owned = [e])),
    e
  );
}
function R(e) {
  if (0 !== e.state) {
    if (e.state === d) return z(e);
    if (e.suspense && S(e.suspense.inFallback)) return e.suspense.effects.push(e);
    const r = [e];
    for (; (e = e.owner) && (!e.updatedAt || e.updatedAt < y); ) e.state && r.push(e);
    for (let o = r.length - 1; 0 <= o; o--) {
      var t;
      (e = r[o]).state === p ? E(e) : e.state === d && ((t = w), (w = null), O(() => z(e, r[0]), !1), (w = t));
    }
  }
}
function O(e, t) {
...
function z(e, t) {
  for (let s = (e.state = 0); s < e.sources.length; s += 1) {
    var r,
      o = e.sources[s];
    o.sources && ((r = o.state) === p ? o !== t && (!o.updatedAt || o.updatedAt < y) && R(o) : r === d && z(o, t));
  }
}
function I(e) {
  for (let r = 0; r < e.observers.length; r += 1) {
    var t = e.observers[r];
    t.state || ((t.state = d), (t.pure ? w : m).push(t), t.observers && I(t));
  }
}
function N(e) {
  let t;
  if (e.sources)
    for (; e.sources.length; ) {
      var r,
        ...
        n = e.sourceSlots.pop(),
        i = s.observers;
      i && i.length && ((r = i.pop()), (o = s.observerSlots.pop()), n < i.length) && ((i[(r.sourceSlots[o] = n)] = r), (s.observerSlots[n] = o));
    }
  if (e.owned) {
...
const H = {
  ...
  set: F,
  deleteProperty: F,
  getOwnPropertyDescriptor: (e, t) => ({ configurable: !0, enumerable: !0, get: () => e.get(t), set: F, deleteProperty: F }),
  ownKeys: (e) => e.keys(),
};
function W(e) {
...
function G(...e) {
  ...
  for (let o = 0; o < e.length; o++) {
    var r = e[o];
    (t = t || (!!r && a in r)), (e[o] = 'function' == typeof r ? ((t = !0), C(r)) : r);
  }
  if (t)
    return new Proxy(
      {
...
function V(e, ...t) {
  ...
  if (a in e)
    return (
      (o = t.map(
        (t) =>
          new Proxy({ get: (r) => (t.includes(r) ? e[r] : void 0), has: (r) => t.includes(r) && r in e, keys: () => t.filter((t) => t in e) }, H),
      )).push(
        new Proxy(
          { get: (t) => (r.has(t) ? void 0 : e[t]), has: (t) => !r.has(t) && t in e, keys: () => Object.keys(e).filter((e) => !r.has(e)) },
          H,
        ),
      ),
      o
  ...
  return (
    t.push(Object.keys(s).filter((e) => !r.has(e))),
    t.map((t) => {
      var r = {};
      for (let o = 0; o < t.length; o++) {
        const n = t[o];
        n in e && Object.defineProperty(r, n, s[n] || { get: () => e[n], set: () => !0, enumerable: !0 });
      }
      return r;
    })
  );
    ...
    (function (e, t, r = {}) {
      ...
      return (
        ...
        () => {
          ...
          return (
            ...
            S(() => {
              let e,
                ...
                y = p.length;
              if (0 === y)
                0 !== i && (q(n), (n = []), (o = []), (s = []), (i = 0), (a = a && [])),
                  r.fallback && ((o = [U]), (s[0] = v((e) => ((n[0] = e), r.fallback()))), (i = 1));
              else if (0 === i) {
                for (s = new Array(y), h = 0; h < y; h++) (o[h] = p[h]), (s[h] = v(d));
                i = y;
              } else {
                for (l = new Array(y), u = new Array(y), a && (f = new Array(y)), g = 0, b = Math.min(i, y); g < b && o[g] === p[g]; g++);
                for (b = i - 1, w = y - 1; b >= g && w >= g && o[b] === p[w]; b--, w--) (l[w] = s[b]), (u[w] = n[b]), a && (f[w] = a[b]);
                for (e = new Map(), t = new Array(w + 1), h = w; h >= g; h--) (m = p[h]), (c = e.get(m)), (t[h] = void 0 === c ? -1 : c), e.set(m, h);
                for (c = g; c <= b; c++)
                  (m = o[c]),
                    void 0 !== (h = e.get(m)) && -1 !== h ? ((l[h] = s[c]), (u[h] = n[c]), a && (f[h] = a[c]), (h = t[h]), e.set(m, h)) : n[c]();
                for (h = g; h < y; h++) h in l ? ((s[h] = l[h]), (n[h] = u[h]), a && ((a[h] = f[h]), a[h](h))) : (s[h] = v(d));
                (s = s.slice(0, (i = y))), (o = p.slice(0));
              }
              return s;
            })
          );
          function d(e) {
            var r;
            return (n[h] = e), a ? (([e, r] = x(h)), (a[h] = r), t(p[h], e)) : t(p[h]);
          }
        }
      );
...
const ee = new Set([
  ...
  te = { xlink: 'http://www.w3.org/1999/xlink', xml: 'http://www.w3.org/XML/1998/namespace' };
...
function oe(e, t, r) {
  ...
  return ((t = t ? () => (o = o || s()).cloneNode(!0) : () => S(() => document.importNode((o = o || s()), !0))).cloneNode = t);
}
function se(e, t = window.document) {
  var r = t[re] || (t[re] = new Set());
  for (let s = 0, n = e.length; s < n; s++) {
    var o = e[s];
    r.has(o) || (r.add(o), t.addEventListener(o, de));
  }
}
function ne(e, t, r) {
...
function ae(e, t = {}, r, o) {
  const s = {};
  return (
    o || k(() => (s.children = ue(e, t.children, s.children))),
    k(() => t.ref && t.ref(e)),
    k(() =>
      (function (e, t, r, o, s = {}, n = !1) {
        t = t || {};
        for (const o in s) o in t || ('children' !== o && (s[o] = pe(e, o, null, s[o], r, n)));
        for (const a in t) {
          var i;
          'children' === a ? o || ue(e, t.children) : ((i = t[a]), (s[a] = pe(e, a, i, s[a], r, n)));
        }
      })(e, t, r, !0, s, !0),
    ),
    s
...
function ce(e, t, r, o) {
  if ((void 0 !== r && (o = o || []), 'function' != typeof t)) return ue(e, t, o, r);
  k((o) => ue(e, t(), o, r), o);
}
function he(e, t, r) {
  var o = t.trim().split(/\s+/);
  for (let t = 0, s = o.length; t < s; t++) e.classList.toggle(o[t], r);
}
function pe(e, t, r, o, s, n) {
  ...
  return 'style' === t
    ? (function (e, t, r) {
        ...
        let s, n;
        for (n in ('string' == typeof r && (o.cssText = r = void 0), (t = t || {}), (r = r || {}))) null == t[n] && o.removeProperty(n), delete r[n];
        for (n in t) (s = t[n]) !== r[n] && (o.setProperty(n, s), (r[n] = s));
        return r;
      })(e, r, o)
    : 'classList' === t
      ? (function (e, t, r = {}) {
          ...
          for (n = 0, i = o.length; n < i; n++) {
            var l = o[n],
              c = !!t[l];
            l && 'undefined' !== l && r[l] !== c && c && (he(e, l, !0), (r[l] = c));
          }
          return r;
        })(e, r, o)
      : r === o
        ...
        : ('ref' === t
            ? n || r(e)
            : 'on:' === t.slice(0, 3)
              ? ((n = t.slice(3)), o && e.removeEventListener(n, o), r && e.addEventListener(n, r))
              : 'oncapture:' === t.slice(0, 10)
                ? ((n = t.slice(10)), o && e.removeEventListener(n, o, !0), r && e.addEventListener(n, r, !0))
                : 'on' === t.slice(0, 2)
                  ? ((n = t.slice(2).toLowerCase()),
                    !(p = ee.has(n)) && o && ((o = Array.isArray(o) ? o[0] : o), e.removeEventListener(n, o)),
                    (p || r) &&
                      ((function (e, t, r, o) {
                        if (o) Array.isArray(r) ? ((e['$$' + t] = r[0]), (e[`$$${t}Data`] = r[1])) : (e['$$' + t] = r);
                        else if (Array.isArray(r)) {
                          const o = r[0];
                          e.addEventListener(t, (r[0] = (t) => o.call(e, r[1], t)));
                  ...
                  : 'attr:' === t.slice(0, 5)
                    ...
                    : (h = 'prop:' === t.slice(0, 5)) ||
                      ...
                      : (o = s && -1 < t.indexOf(':') && te[t.split(':')[0]])
                        ? (function (e, t, r, o) {
                            null == o ? e.removeAttributeNS(t, r) : e.setAttributeNS(t, r, o);
                          })(e, o, t, r)
                        : ne(e, Q[t] || t, r),
          r);
}
function de(e) {
  ...
  for (
    e.target !== r && Object.defineProperty(e, 'target', { configurable: !0, value: r }),
      Object.defineProperty(e, 'currentTarget', { configurable: !0, get: () => r || document });
    r;
    ...
    if (o && !r.disabled) {
      var s = r[t + 'Data'];
      if ((void 0 !== s ? o.call(r, s, e) : o.call(r, e), e.cancelBubble)) return;
    }
    r = r._$host || r.parentNode || r.host;
  }
}
function ue(e, t, r, o, s) {
  for (; 'function' == typeof r; ) r = r();
  if (t !== r) {
    var n = typeof t,
      i = void 0 !== o;
    if (((e = (i && r[0] && r[0].parentNode) || e), 'string' == n || 'number' == n))
      if (('number' == n && (t = t.toString()), i)) {
        let s = r[0];
        s && 3 === s.nodeType ? (s.data = t) : (s = document.createTextNode(t)), (r = be(e, r, o, s));
      } else r = '' !== r && 'string' == typeof r ? (e.firstChild.data = t) : (e.textContent = t);
    else if (null == t || 'boolean' == n) r = be(e, r, o);
    else {
      if ('function' == n)
        return (
          k(() => {
      ...
      if (Array.isArray(t)) {
        const a = [];
        if (((n = r && Array.isArray(r)), fe(a, t, r, s))) return k(() => (r = ue(e, a, r, o, !0))), () => r;
        if (0 === a.length) {
          if (((r = be(e, r, o)), i)) return r;
        } else
          n
            ? 0 === r.length
              ? ge(e, a, o)
              : (function (e, t, r) {
                  ...
                  for (; i < s || a < n; )
                    if (t[i] === r[a]) i++, a++;
                      ...
                      for (; t[s - 1] === r[n - 1]; ) s--, n--;
                      if (s === i) for (var h = n < o ? (a ? r[a - 1].nextSibling : r[n - a]) : l; a < n; ) e.insertBefore(r[a++], h);
                      else if (n === a) for (; i < s; ) (c && c.has(t[i])) || t[i].remove(), i++;
                      else if (t[i] === r[n - 1] && r[a] === t[s - 1]) {
                        var p = t[--s].nextSibling;
                        e.insertBefore(r[a++], t[i++].nextSibling), e.insertBefore(r[--n], p), (t[s] = r[n]);
                      } else {
                        if (!c) {
                          c = new Map();
                          let e = a;
                        ...
                        if (null != d)
                          if (a < d && d < n) {
                            let o,
                              l = i,
                              h = 1;
                            for (; ++l < s && l < n && null != (o = c.get(t[l])) && o === d + h; ) h++;
                            if (h > d - a) for (var u = t[i]; a < d; ) e.insertBefore(r[a++], u);
...
function fe(e, t, r, o) {
  ...
  for (let i = 0, a = t.length; i < a; i++) {
    ...
    if (a instanceof Node) e.push(a);
      ...
      if (Array.isArray(a)) s = fe(e, a, l) || s;
      else if ('function' == typeof a)
        if (o) {
          for (; 'function' == typeof a; ) a = a();
          s = fe(e, Array.isArray(a) ? a : [a], Array.isArray(l) ? l : [l]) || s;
        } else e.push(a), (s = !0);
      else {
        var n = String(a);
        l && 3 === l.nodeType ? ((l.data = n), e.push(l)) : e.push(document.createTextNode(n));
      }
  }
  return s;
}
function ge(e, t, r = null) {
  for (let o = 0, s = t.length; o < s; o++) e.insertBefore(t[o], r);
}
function be(e, t, r, o) {
  if (void 0 === r) return (e.textContent = '');
  var s = o || document.createTextNode('');
  if (t.length) {
    let o = !1;
    for (let a = t.length - 1; 0 <= a; a--) {
      var n,
        i = t[a];
      s !== i ? ((n = i.parentNode === e), o || a ? n && i.remove() : n ? e.replaceChild(s, i) : e.insertBefore(s, r)) : (o = !0);
    }
  ...
  return (t, r) => {
    ...
    return v(
      (s) => {
        ...
        o.addPropertyChangedCallback((e, t) => (n[e] = t)),
          o.addReleaseCallback(() => {
            (o.renderRoot.textContent = ''), s();
          });
        var i = e(n, r);
        return ce(o.renderRoot, i);
      },
      (function (e) {
...
const ye = { chatflowid: '', apiHost: void 0, chatflowConfig: void 0, theme: void 0, observersConfig: void 0 };
var ve =
...
const xe = (e) => null == e,
    ...
    try {
      var t = 'string' == typeof e ? e : e.url,
        r = await fetch(t, {
          ...
          mode: 'cors',
          headers: 'string' != typeof e && ke(e.body) ? { 'Content-Type': 'application/json' } : void 0,
          body: 'string' != typeof e && ke(e.body) ? JSON.stringify(e.body) : void 0,
        });
      let s;
      var o = r.headers.get('Content-Type');
      if (
        ((s = o && o.includes('application/json') ? await r.json() : 'string' != typeof e && 'blob' === e.type ? await r.blob() : await r.text()),
        r.ok)
      )
        return { data: s };
      {
        let e;
        throw (e = 'object' == typeof s && 'error' in s ? s.error : s || r.statusText);
      }
    } catch (e) {
  ...
  Se = oe('<img alt="Bubble button icon">'),
  Ae = oe(
          ...
          D(X, {
            ...
            get children() {
              ...
              return (
                k(
                  (r) => {
                    var o = e.iconColor ?? 'white',
                      s =
                        'stroke-2 fill-transparent absolute duration-200 transition ' +
                        (e.isBotOpened ? 'scale-0 opacity-0' : 'scale-100 opacity-100') +
                        ('large' === e.size ? ' w-9' : ' w-7');
                    return (
                      o !== r._v$ && (null != (r._v$ = o) ? t.style.setProperty('stroke', o) : t.style.removeProperty('stroke')),
                      s !== r._v$2 && ne(t, 'class', (r._v$2 = s)),
                      r
                    );
                  },
          ...
          D(X, {
            ...
            get children() {
              ...
              return (
                k(
                  (r) => {
                    var o = e.customIconSrc,
                      s =
                        'rounded-full object-cover' +
                        (e.isBotOpened ? 'scale-0 opacity-0' : 'scale-100 opacity-100') +
                        ('large' === e.size ? ' w-9 h-9' : ' w-7 h-7');
                    return o !== r._v$3 && ne(t, 'src', (r._v$3 = o)), s !== r._v$4 && ie(t, (r._v$4 = s)), r;
                  },
          ...
          (o) => {
            var s =
              ...
              c =
                ...
                (e.isBotOpened ? 'scale-100 rotate-0 opacity-100' : 'scale-0 -rotate-180 opacity-0') +
                ('large' === e.size ? ' w-9' : ' w-7');
            return (
              s !== o._v$5 && ie(t, (o._v$5 = s)),
              n !== o._v$6 && (null != (o._v$6 = n) ? t.style.setProperty('background-color', n) : t.style.removeProperty('background-color')),
              i !== o._v$7 && (null != (o._v$7 = i) ? t.style.setProperty('right', i) : t.style.removeProperty('right')),
              a !== o._v$8 && (null != (o._v$8 = a) ? t.style.setProperty('bottom', a) : t.style.removeProperty('bottom')),
              l !== o._v$9 && (null != (o._v$9 = l) ? r.style.setProperty('fill', l) : r.style.removeProperty('fill')),
              c !== o._v$10 && ne(r, 'class', (o._v$10 = c)),
              o
            );
          },
...
function Ee() {
  if ((Pe = Pe || ('undefined' != typeof crypto && crypto.getRandomValues && crypto.getRandomValues.bind(crypto)))) return Pe(Te);
...
var Re,
  Oe,
  Le = { randomUUID: 'undefined' != typeof crypto && crypto.randomUUID && crypto.randomUUID.bind(crypto) };
function je(e, t, r) {
  if (Le.randomUUID && !t && !e) return Le.randomUUID();
  var o = (e = e || {}).random || (e.rng || Ee)();
...
const ze = ({ chatflowid: e, apiHost: t = 'http://localhost:3000', body: r }) => _e({ method: 'POST', url: t + '/api/v1/feedback/' + e, body: r }),
  Ie = ({ apiHost: e = 'http://localhost:3000', body: t }) =>
    _e({ method: 'POST', url: e + '/api/v1/openai-assistants-file', body: t, type: 'blob' }),
  Ne = oe(
  ...
  Me = (e) => {
    ...
    return (
      ((o = Ne()).$$input = (e) => t.onInput(e.currentTarget.value)),
      'function' == typeof (s = e.ref) ? le(s, o) : (e.ref = o),
      ae(
        o,
        G(
          {
      ...
      return (
        k(
          (r) => {
            var o = e.color ?? 'none',
              s = e.color ?? '#3B81F6';
            return o !== r._v$ && ne(t, 'fill', (r._v$ = o)), s !== r._v$2 && ne(t, 'stroke', (r._v$2 = s)), r;
          },
          { _v$: void 0, _v$2: void 0 },
        ),
        t
  ...
  xt = oe('<span>Send'),
  kt = oe('<div class="flex items-center justify-between chatbot-input border border-[#eeeeee]" data-testid="input">'),
  _t = oe('<span>Image Upload'),
  Ct = oe('<input multiple type="file">'),
  St = oe('<span>Record Audio'),
  At = (e) => {
    const [t, r] = x(e.defaultValue ?? '');
    let o, s;
    const n = (e) => r(e),
      i = () => {
        '' !== t() && o?.reportValidity() && e.onSubmit(t()), r('');
      },
      a = (e) => {
        ...
        });
    {
      ...
      return (
            ...
            return () => {
              return t()
                ? [
                    ...
                    ((r = Ct()).addEventListener('change', c),
                    'function' == typeof (o = s) ? le(o, r) : (s = r),
        ...
        k(
          (t) => {
            var o = e.backgroundColor ?? '#ffffff',
              s = e.textColor ?? '#303235';
            return (
              o !== t._v$ && (null != (t._v$ = o) ? r.style.setProperty('background-color', o) : r.style.removeProperty('background-color')),
              s !== t._v$2 && (null != (t._v$2 = s) ? r.style.setProperty('color', s) : r.style.removeProperty('color')),
              t
            );
          },
          { _v$: void 0, _v$2: void 0 },
  ...
  Pt = () => {
    {
      ...
      return (
        k(
          (r) => {
            var o = 'flex justify-center items-center rounded-full text-white relative ' + (Ue() ? 'w-6 h-6 text-sm' : 'w-10 h-10 text-xl'),
              s = 'absolute top-0 left-0 ' + (Ue() ? ' w-6 h-6 text-sm' : 'w-full h-full text-xl');
            return o !== r._v$ && ie(e, (r._v$ = o)), s !== r._v$2 && ne(t, 'class', (r._v$2 = s)), r;
          },
          { _v$: void 0, _v$2: void 0 },
        ),
        e
  ...
  Tt = oe('<figure><img alt="Bot avatar" class="rounded-full object-cover w-full h-full">'),
  Et = (e) => {
            ...
            k(
              (o) => {
                var s =
                    ...
                    (Ue() ? 'w-6 h-6 text-sm' : 'w-10 h-10 text-xl'),
                  n = t();
                return s !== o._v$ && ie(e, (o._v$ = s)), n !== o._v$2 && ne(r, 'src', (o._v$2 = n)), o;
              },
              { _v$: void 0, _v$2: void 0 },
            ),
            e
...
function It(e, t) {
  if (t) {
    if (Rt.test(e)) return e.replace(Ot, (e) => Lt[e]);
  } else if (jt.test(e)) return e.replace(zt, (e) => Lt[e]);
  return e;
}
function Nt(e) {
...
var Mt;
((Mt = Re = Re || {})[(Mt.space = 1)] = 'space'),
  (Mt[(Mt.text = 2)] = 'text'),
  (Mt[(Mt.paragraph = 3)] = 'paragraph'),
  (Mt[(Mt.heading = 4)] = 'heading'),
  (Mt[(Mt.listStart = 5)] = 'listStart'),
  (Mt[(Mt.listEnd = 6)] = 'listEnd'),
  (Mt[(Mt.looseItemStart = 7)] = 'looseItemStart'),
  (Mt[(Mt.looseItemEnd = 8)] = 'looseItemEnd'),
  (Mt[(Mt.listItemStart = 9)] = 'listItemStart'),
  (Mt[(Mt.listItemEnd = 10)] = 'listItemEnd'),
  (Mt[(Mt.blockquoteStart = 11)] = 'blockquoteStart'),
  (Mt[(Mt.blockquoteEnd = 12)] = 'blockquoteEnd'),
  (Mt[(Mt.code = 13)] = 'code'),
  (Mt[(Mt.table = 14)] = 'table'),
  (Mt[(Mt.html = 15)] = 'html'),
  (Mt[(Mt.hr = 16)] = 'hr');
class Ut {
  gfm = !0;
...
class qt {
  options;
  constructor(e) {
    this.options = e || Ht.options;
  }
  code(e, t, r, o) {
    this.options.highlight && null != (s = this.options.highlight(e, t)) && s !== e && ((r = !0), (e = s));
    var s = r ? e : this.options.escape(e, !0);
    return t
  ...
  link(e, t, r) {
    if (this.options.sanitize) {
      let o;
      try {
        o = decodeURIComponent(this.options.unescape(e))
          .replace(/[^\w:]/g, '')
          .toLowerCase();
      } catch (t) {
        return r;
      }
      if (0 === o.indexOf('javascript:') || 0 === o.indexOf('vbscript:') || 0 === o.indexOf('data:')) return r;
    }
    let o = '<a href="' + e + '"';
...
class Dt {
  ...
  hasRulesGfm;
  ruleCallbacks;
  constructor(e, t, r = Ht.options, o) {
    if (
      ((this.staticThis = e), (this.links = t), (this.options = r), (this.renderer = o || this.options.renderer || new qt(this.options)), !this.links)
    )
  ...
  static getRulesBase() {
    ...
    return (
      ...
      (((e = {
        ...
        _inside: /(?:\[[^\]]*\]|[^\[\]]|\](?=[^\[]*\]))*/,
        _href: /\s*<?([\s\S]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/,
      }).link = new Bt(e.link).setGroup('inside', e._inside).setGroup('href', e._href).getRegexp()),
      (e.reflink = new Bt(e.reflink).setGroup('inside', e._inside).getRegexp()),
      (this.rulesBase = e))
    );
  }
  ...
  static getRulesGfm() {
    ...
    return (
      this.rulesGfm ||
      ((e = this.getRulesBase()),
      (t = new Bt(e.escape).setGroup('])', '~|])').getRegexp()),
      (r = new Bt(e.text).setGroup(']|', '~]|').setGroup('|', '|https?://|').getRegexp()),
      (this.rulesGfm = { ...e, escape: t, url: /^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/, del: /^~~(?=\S)([\s\S]*?\S)~~/, text: r }))
    );
  }
  static getRulesBreaks() {
    ...
    return (
      ...
      ((e = this.getRulesGfm()),
      (t = this.getRulesGfm()),
      (this.rulesBreaks = { ...t, br: new Bt(e.br).setGroup('{2,}', '*').getRegexp(), text: new Bt(t.text).setGroup('{2,}', '*').getRegexp() }))
    );
  }
  setRules() {
    this.options.gfm
    ...
    for (; e; )
      if ((t = this.rules.escape.exec(e))) (e = e.substring(t[0].length)), (r += t[1]);
        ...
        (e = e.substring(t[0].length)),
          (s =
            '@' === t[2]
              ? ((o = this.options.escape(':' === t[1].charAt(6) ? this.mangle(t[1].substring(7)) : this.mangle(t[1]))), this.mangle('mailto:') + o)
              : (o = this.options.escape(t[1]))),
          (r += this.renderer.link(s, null, o));
      } else if (!this.inLink && this.hasRulesGfm && (t = this.rules.url.exec(e))) {
        e = e.substring(t[0].length);
        var o = this.options.escape(t[1]);
        r += this.renderer.link(o, null, o);
      } else if ((t = this.rules.tag.exec(e)))
        !this.inLink && /^<a /i.test(t[0]) ? (this.inLink = !0) : this.inLink && /^<\/a>/i.test(t[0]) && (this.inLink = !1),
          (e = e.substring(t[0].length)),
          (r += this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(t[0]) : this.options.escape(t[0])) : t[0]);
      else if ((t = this.rules.link.exec(e)))
        (e = e.substring(t[0].length)), (this.inLink = !0), (r += this.outputLink(t, { href: t[2], title: t[3] })), (this.inLink = !1);
      else if ((t = (t = this.rules.reflink.exec(e)) || this.rules.nolink.exec(e))) {
        e = e.substring(t[0].length);
        o = (t[2] || t[1]).replace(/\s+/g, ' ');
        var s = this.links[o.toLowerCase()];
        s && s.href ? ((this.inLink = !0), (r += this.outputLink(t, s)), (this.inLink = !1)) : ((r += t[0].charAt(0)), (e = t[0].substring(1) + e));
  ...
  outputLink(e, t) {
    ...
    return '!' !== e[0].charAt(0) ? this.renderer.link(r, t, this.output(e[1])) : this.renderer.image(r, t, this.options.escape(e[1]));
  }
  smartypants(e) {
  ...
  mangle(e) {
    ...
    for (let o = 0; o < r; o++) {
      let r;
      0.5 < Math.random() && (r = 'x' + e.charCodeAt(o).toString(16)), (t += '&#' + r + ';');
    }
    return t;
  }
}
class Ft {
  ...
  line = 0;
  constructor(e) {
    (this.tokens = []), (this.token = null), (this.options = e || Ht.options), (this.renderer = this.options.renderer || new qt(this.options));
  }
  static parse(e, t, r) {
    return new this(r).parse(t, e);
  }
  parse(e, t) {
    (this.inlineLexer = new Dt(Dt, e, this.options, this.renderer)), (this.tokens = t.reverse());
    let r = '';
  ...
  debug(e, t) {
    ...
    for (; this.next(); ) {
      var o = this.tok();
      (this.token.line = this.line += o.split('\n').length - 1), (r += o);
    }
    return r;
  }
  next() {
  ...
  parseText() {
    ...
    for (var t; (t = this.getNextElement()) && t.type == Re.text; ) e += '\n' + this.next().text;
  ...
  tok() {
    switch (this.token.type) {
      ...
      case Re.listStart: {
        let t = '';
        for (var e = this.token.ordered; this.next().type != Re.listEnd; ) t += this.tok();
        return this.renderer.list(t, e);
      }
      case Re.listItemStart: {
        let e = '';
        for (; this.next().type != Re.listItemEnd; ) e += this.token.type == Re.text ? this.parseText() : this.tok();
        return this.renderer.listitem(e);
      }
      case Re.looseItemStart: {
        let e = '';
        for (; this.next().type != Re.listItemEnd; ) e += this.tok();
        return this.renderer.listitem(e);
      }
      case Re.code:
      ...
      case Re.table: {
        ...
        for (let e = 0; e < this.token.header.length; e++) {
          ...
          o += this.renderer.tablecell(r, t);
        }
        e += this.renderer.tablerow(o);
        for (const e of this.token.cells) {
          o = '';
          for (let t = 0; t < e.length; t++) o += this.renderer.tablecell(this.inlineLexer.output(e[t]), { header: !1, align: this.token.align[t] });
          s += this.renderer.tablerow(o);
        }
        return this.renderer.table(e, s);
      }
      case Re.blockquoteStart: {
        let e = '';
        for (; this.next().type != Re.blockquoteEnd; ) e += this.tok();
        return this.renderer.blockquote(e);
      }
      case Re.hr:
        return this.renderer.hr();
      case Re.html:
        return (e = this.token.pre || this.options.pedantic ? this.token.text : this.inlineLexer.output(this.token.text)), this.renderer.html(e);
      default:
        ...
        if (((e = `Token with "${this.token.type}" type was not found.`), !this.options.silent)) throw new Error(e);
        console.log(e);
    }
  }
}
class Ht {
  ...
  static parse(e, t) {
    try {
      t = { ...this.options, ...t };
      var { tokens: r, links: o } = this.callBlockLexer(e, t);
      return this.callParser(r, o, t);
    } catch (e) {
  ...
  static debug(e, t = this.options) {
    ...
    let o = e.slice();
    return (
      ((t = new Ft(t)).simpleRenderers = this.simpleRenderers),
      (t = t.debug(r, e)),
      {
        tokens: (o = o.map((e) => {
          e.type = Re[e.type] || e.type;
          var t = e.line;
  ...
  static callParser(e, t, r) {
    var o;
    return this.simpleRenderers.length ? (((o = new Ft(r)).simpleRenderers = this.simpleRenderers), o.parse(t, e)) : Ft.parse(e, t, r);
  }
  static callMe(e) {
    if (((e.message += '\nPlease report this to https://github.com/ts-stack/markdown'), this.options.silent))
      return '<p>An error occured:</p><pre>' + this.options.escape(e.message + '', !0) + '</pre>';
    throw e;
  }
}
class Wt {
  ...
  hasRulesTables;
  constructor(e, t) {
    (this.staticThis = e), (this.options = t || Ht.options), this.setRules();
  }
  static lex(e, t, r, o) {
    return new this(this, t).getTokens(e, r, o);
  }
  static getRulesBase() {
    var e, t;
    return (
      ...
      (((e = {
        ...
        bullet: /(?:[*+-]|\d+\.)/,
        item: /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/,
      }).item = new Bt(e.item, 'gm').setGroup(/bull/g, e.bullet).getRegexp()),
      (e.list = new Bt(e.list)
      ...
      (e.html = new Bt(e.html)
        .setGroup('comment', /<!--[\s\S]*?-->/)
        .setGroup('closed', /<(tag)[\s\S]+?<\/\1>/)
        .setGroup('closing', /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)
        .setGroup(/tag/g, t)
        .getRegexp()),
      (e.paragraph = new Bt(e.paragraph)
        .setGroup('hr', e.hr)
  ...
  static getRulesGfm() {
    ...
    return (
      ...
      (o = e.list.source.replace('\\1', '\\3')),
      (t.paragraph = new Bt(e.paragraph).setGroup('(?!', `(?!${r}|${o}|`).getRegexp()),
      (this.rulesGfm = t))
    );
  }
  ...
  getTokens(e, t, r) {
    ...
    e: for (; s; )
      if (
        ((o = this.rules.newline.exec(s)) && ((s = s.substring(o[0].length)), 1 < o[0].length) && this.tokens.push({ type: Re.space }),
        (o = this.rules.code.exec(s)))
      ) {
        s = s.substring(o[0].length);
        var n = o[0].replace(/^ {4}/gm, '');
        this.tokens.push({ type: Re.code, text: this.options.pedantic ? n : n.replace(/\n+$/, '') });
      } else if (this.hasRulesGfm && (o = this.rules.fences.exec(s)))
        (s = s.substring(o[0].length)), this.tokens.push({ type: Re.code, meta: o[2], lang: o[3], text: o[4] || '' });
      else if ((o = this.rules.heading.exec(s)))
        (s = s.substring(o[0].length)), this.tokens.push({ type: Re.heading, depth: o[1].length, text: o[2] });
      else if (t && this.hasRulesTables && (o = this.rules.nptable.exec(s))) {
        s = s.substring(o[0].length);
        var i = {
          type: Re.table,
        ...
        this.tokens.push(i);
      } else if ((o = this.rules.lheading.exec(s)))
        (s = s.substring(o[0].length)), this.tokens.push({ type: Re.heading, depth: '=' === o[2] ? 1 : 2, text: o[1] });
      else if ((o = this.rules.hr.exec(s))) (s = s.substring(o[0].length)), this.tokens.push({ type: Re.hr });
      else if ((o = this.rules.blockquote.exec(s)))
        (s = s.substring(o[0].length)),
          this.tokens.push({ type: Re.blockquoteStart }),
          (n = o[0].replace(/^ *> ?/gm, '')),
          this.getTokens(n),
          this.tokens.push({ type: Re.blockquoteEnd });
      else if ((o = this.rules.list.exec(s))) {
        s = s.substring(o[0].length);
        var l,
          c = o[2],
          h = (this.tokens.push({ type: Re.listStart, ordered: 1 < c.length }), o[0].match(this.rules.item)),
          p = h.length;
        let e,
          t = !1;
        for (let o = 0; o < p; o++) {
          ...
          (l = n.length),
            -1 !== (n = n.replace(/^ *([*+-]|\d+\.) +/, '')).indexOf('\n ') &&
              ((l -= n.length), (n = this.options.pedantic ? n.replace(/^ {1,4}/gm, '') : n.replace(new RegExp('^ {1,' + l + '}', 'gm'), ''))),
            !this.options.smartLists ||
              o === p - 1 ||
              c === (l = this.staticThis.getRulesBase().bullet.exec(h[o + 1])[0]) ||
              (1 < c.length && 1 < l.length) ||
              ((s = h.slice(o + 1).join('\n') + s), (o = p - 1)),
            (e = t || /\n\n(?!\s*$)/.test(n)),
            o !== p - 1 && ((t = '\n' === n.charAt(n.length - 1)), (e = e || t)),
            this.tokens.push({ type: e ? Re.looseItemStart : Re.listItemStart }),
            this.getTokens(n, !1, r),
            this.tokens.push({ type: Re.listItemEnd });
        }
        this.tokens.push({ type: Re.listEnd });
      } else if ((o = this.rules.html.exec(s))) {
        s = s.substring(o[0].length);
        var d = o[1];
        this.tokens.push({
          type: this.options.sanitize ? Re.paragraph : Re.html,
          pre: !this.options.sanitizer && ('pre' === d || 'script' === d || 'style' === d),
          text: o[0],
        });
      } else if (t && (o = this.rules.def.exec(s))) (s = s.substring(o[0].length)), (this.links[o[1].toLowerCase()] = { href: o[2], title: o[3] });
      else if (t && this.hasRulesTables && (o = this.rules.table.exec(s))) {
        s = s.substring(o[0].length);
        var u = {
          type: Re.table,
          header: o[1].replace(/^ *| *\| *$/g, '').split(/ *\| */),
        ...
        for (let e = 0; e < u.align.length; e++)
          /^ *-+: *$/.test(u.align[e])
            ? (u.align[e] = 'right')
            : /^ *:-+: *$/.test(u.align[e])
              ? (u.align[e] = 'center')
              : /^ *:-+ *$/.test(u.align[e])
                ...
                : (u.align[e] = null);
        var f = o[3].replace(/(?: *\| *)?\n$/, '').split('\n');
        for (let e = 0; e < f.length; e++) u.cells[e] = f[e].replace(/^ *\| *| *\| *$/g, '').split(/ *\| */);
        this.tokens.push(u);
      } else {
        if (this.staticThis.simpleRules.length) {
          ...
          for (let e = 0; e < g.length; e++)
            if ((o = g[e].exec(s))) {
              ...
              this.tokens.push({ type: b, execArr: o });
              continue e;
            }
        }
        if (t && (o = this.rules.paragraph.exec(s)))
          (s = s.substring(o[0].length)),
            '\n' === o[1].slice(-1)
              ? this.tokens.push({ type: Re.paragraph, text: o[1].slice(0, -1) })
              : this.tokens.push({ type: 0 < this.tokens.length ? Re.paragraph : Re.text, text: o[1] });
        else if ((o = this.rules.text.exec(s))) (s = s.substring(o[0].length)), this.tokens.push({ type: Re.text, text: o[0] });
        else if (s) throw new Error('Infinite loop on byte: ' + s.charCodeAt(0) + `, near text '${s.slice(0, 30)}...'`);
      }
...
const Gt = oe(
  ...
  Vt = oe('<div class="flex flex-col items-start flex-wrap w-full gap-2">'),
  Yt = oe('<div class="flex items-center justify-center max-w-[128px] mr-[10px] p-0 m-0"><img class="w-full h-full bg-cover">'),
  Xt = oe(
  ...
  Jt = oe('<span class="mr-2 whitespace-pre-wrap">'),
  Kt =
    (Ht.setOptions({ isNoP: !0 }),
    (e) => {
      let t;
      A(() => {
        t && (t.innerHTML = Ht.parse(e.message.message));
      });
      {
        const r = Gt(),
          o = r.firstChild;
        return (
          ...
          o.style.setProperty('border-radius', '6px'),
          ce(
            o,
            (() => {
              const t = C(() => !!(e.message.fileUploads && 0 < e.message.fileUploads.length));
              return () => {
                return (
                  t() &&
                  (ce(
                    ...
                    D(Y, {
                      ...
                      children: (t) => {
                        var r = `${e.apiHost}/api/v1/get-upload-file?chatflowId=${e.chatflowid}&chatId=${e.chatId}&fileName=` + t.name;
                        const o = t.data ?? r;
                        return C(
                          (() => {
                            const e = C(() => !(!t.mime || !t.mime.startsWith('image/')));
                            return () => {
                              if (e()) return ne((r = Yt()).firstChild, 'src', o), r;
                              {
                                const e = Xt(),
                                  r = e.firstChild.nextSibling;
                                return ne(r, 'src', o), k(() => ne(r, 'type', t.mime)), e;
                              }
                            };
                          })(),
                        );
              ...
              return () =>
                ...
                (() => {
                  ...
                  return (
                    ...
                    k(() =>
                      null != (e.fontSize ? e.fontSize + 'px' : '16')
                        ? r.style.setProperty('font-size', e.fontSize ? e.fontSize + 'px' : '16')
          ...
          k(
            (t) => {
              var r = e.backgroundColor ?? '#3B81F6',
                s = e.textColor ?? '#ffffff';
              return (
                r !== t._v$ && (null != (t._v$ = r) ? o.style.setProperty('background-color', r) : o.style.removeProperty('background-color')),
                s !== t._v$2 && (null != (t._v$2 = s) ? o.style.setProperty('color', s) : o.style.removeProperty('color')),
                t
              );
            },
            { _v$: void 0, _v$2: void 0 },
    ...
    return [
      (() => {
        const i = or(),
          ...
          h = l.nextSibling,
          p = h.firstChild,
          d = h.nextSibling.firstChild;
        l.style.setProperty('border', '1px solid #eeeeee'), (c.$$click = n);
        return (
          'function' == typeof o ? le(o, p) : (o = p),
          (p.$$input = (e) => ((e = e.currentTarget.value), r(e))),
          p.style.setProperty('border', '1px solid #eeeeee'),
          (d.$$click = s),
          k(
            (t) => {
              var r = e.backgroundColor ?? '#ffffff',
                o = e.textColor ?? nr,
                s = e.textColor ?? nr;
              return (
                r !== t._v$ && (null != (t._v$ = r) ? a.style.setProperty('background-color', r) : a.style.removeProperty('background-color')),
                o !== t._v$2 && (null != (t._v$2 = o) ? a.style.setProperty('color', o) : a.style.removeProperty('color')),
                s !== t._v$3 && (null != (t._v$3 = s) ? p.style.setProperty('color', s) : p.style.removeProperty('color')),
                t
              );
            },
  ...
  ar = (se(['click', 'input']), oe('<div class="flex flex-col justify-start mb-2 items-start host-container">')),
  lr = oe('<span class="px-4 py-2 ml-2 max-w-full chatbot-host-bubble prose" data-testid="host-bubble">'),
  cr = oe('<div class="flex items-center px-2">'),
  hr =
    (Ht.setOptions({ isNoP: !0 }),
    (e) => {
      let t;
      const [r, o] = x(''),
        ...
        l = async () => {
          if ('' === r()) {
            var t = { chatflowid: e.chatflowid, chatId: e.chatId, messageId: e.message?.messageId, rating: 'THUMBS_UP', content: '' };
            if ((t = await ze({ chatflowid: e.chatflowid, apiHost: e.apiHost, body: t })).data) {
              let e = '';
              (t = t.data) && t.id && (e = t.id), o('THUMBS_UP'), n(e), a(!0);
            }
          }
        },
        c = async () => {
          if ('' === r()) {
            var t = { chatflowid: e.chatflowid, chatId: e.chatId, messageId: e.message?.messageId, rating: 'THUMBS_DOWN', content: '' };
            if ((t = await ze({ chatflowid: e.chatflowid, apiHost: e.apiHost, body: t })).data) {
              let e = '';
              (t = t.data) && t.id && (e = t.id), o('THUMBS_DOWN'), n(e), a(!0);
            }
          }
        },
        h = async (t) => {
          (t = { content: t }),
            (
              await (({ id: e, apiHost: t = 'http://localhost:3000', body: r }) => _e({ method: 'PUT', url: t + '/api/v1/feedback/' + e, body: r }))({
                id: s(),
                apiHost: e.apiHost,
                body: t,
              })
      ...
      return (
        A(() => {
          if (
            t &&
            ((t.innerHTML = Ht.parse(e.message.message)),
            ...
            for (const s of e.fileAnnotations) {
              var r = document.createElement('button'),
                o =
                  ((r.textContent = s.fileName),
                  (r.className =
                  ...
                  r.addEventListener('click', function () {
                    (async (t) => {
                      try {
                        var r = await Ie({ apiHost: e.apiHost, body: { question: '', history: [], fileName: t.fileName } }),
                          o = new Blob([r.data]),
                          s = window.URL.createObjectURL(o),
                          n = document.createElement('a');
                        (n.href = s), (n.download = t.fileName), document.body.appendChild(n), n.click(), n.remove();
                      } catch (t) {
        ...
        (p = ar()).style.setProperty('margin-right', '50px'),
        ce(
          p,
          D(X, {
            get when() {
            ...
            return () =>
              ...
              (() => {
                ...
                return (
                  ...
                  k(
                    (t) => {
                      var o = e.backgroundColor ?? '#f7f8ff',
                        s = e.textColor ?? '#303235',
                        n = e.fontSize ? e.fontSize + 'px' : '16';
                      return (
                        o !== t._v$ &&
                          (null != (t._v$ = o) ? r.style.setProperty('background-color', o) : r.style.removeProperty('background-color')),
                        s !== t._v$2 && (null != (t._v$2 = s) ? r.style.setProperty('color', s) : r.style.removeProperty('color')),
                        n !== t._v$3 && (null != (t._v$3 = n) ? r.style.setProperty('font-size', n) : r.style.removeProperty('font-size')),
                        t
                      );
                    },
                    { _v$: void 0, _v$2: void 0, _v$3: void 0 },
        ...
        ce(
          p,
          (() => {
            const o = C(() => !(!e.chatFeedbackStatus || !e.message.messageId));
            return () => {
              return (
                o() && [
                  (ce(
                  ...
                  ce(
                    s,
                    (() => {
                      const e = C(() => !('' !== r() && 'THUMBS_DOWN' !== r()));
                      return () =>
                        e()
                          ? D(rr, {
                              get isDisabled() {
                                return 'THUMBS_DOWN' === r();
                              },
                              get rating() {
                                return r();
                              },
  ...
  fr = () => {
    return ce((e = ur()).firstChild, D(dr, {})), e;
  },
  gr = oe(
  ...
  yr =
    (se(['click']),
    oe(
      '<span class="w-full text-center px-[10px] pt-[6px] pb-[10px] m-auto text-[13px]">Crunched by<a href="https://www.crunchlabs.com" target="_blank" rel="noopener noreferrer" class="lite-badge" id="lite-badge"><span> Crunch Labs',
    )),
  vr = '#303235',
  xr = (e) => {
    let t, r;
    ...
    A(() => {
      document && e.botContainer && (r = new MutationObserver(o)).observe(e.botContainer, { subtree: !1, childList: !0 });
    }),
      $(() => {
        r && r.disconnect();
      });
    {
      ...
      return (
        ...
        k(
          (t) => {
            var s = e.poweredByTextColor ?? vr,
              n = e.badgeBackgroundColor ?? '#ffffff',
              i = e.poweredByTextColor ?? vr;
            return (
              s !== t._v$ && (null != (t._v$ = s) ? r.style.setProperty('color', s) : r.style.removeProperty('color')),
              n !== t._v$2 && (null != (t._v$2 = n) ? r.style.setProperty('background-color', n) : r.style.removeProperty('background-color')),
              i !== t._v$3 && (null != (t._v$3 = i) ? o.style.setProperty('color', i) : o.style.removeProperty('color')),
              t
            );
          },
          { _v$: void 0, _v$2: void 0, _v$3: void 0 },
  ...
  Sr = 'function' == typeof Blob || ('undefined' != typeof Blob && '[object BlobConstructor]' === Object.prototype.toString.call(Blob)),
  Ar = 'function' == typeof ArrayBuffer,
  $r = (e) => ('function' == typeof ArrayBuffer.isView ? ArrayBuffer.isView(e) : e && e.buffer instanceof ArrayBuffer),
  Pr = ({ type: e, data: t }, r, o) =>
    Sr && t instanceof Blob
      ? r
        ? o(t)
        : Tr(t, o)
      : Ar && (t instanceof ArrayBuffer || $r(t))
        ? r
          ? o(t)
          : Tr(new Blob([t]), o)
        : o(kr[e] + (t || '')),
...
for (let e = 0; e < 64; e++) Or[Rr.charCodeAt(e)] = e;
const Lr = 'function' == typeof ArrayBuffer,
  jr = (e, t) => {
    var r;
    return 'string' != typeof e
      ? { type: 'message', data: Ir(e, t) }
      : 'b' === (r = e.charAt(0))
        ? { type: 'message', data: zr(e.substring(1), t) }
        : _r[r]
          ? 1 < e.length
            ? { type: _r[r], data: e.substring(1) }
            : { type: _r[r] }
          : Cr;
  },
  zr = (e, t) => {
    ...
    return Lr
      ? ((r = ((e) => {
          ...
          for (t = 0; t < a; t += 4)
            (r = Or[e.charCodeAt(t)]),
              (o = Or[e.charCodeAt(t + 1)]),
              (s = Or[e.charCodeAt(t + 2)]),
              (n = Or[e.charCodeAt(t + 3)]),
              (h[l++] = (r << 2) | (o >> 4)),
              (h[l++] = ((15 & o) << 4) | (s >> 2)),
              (h[l++] = ((3 & s) << 6) | (63 & n));
          return c;
  ...
  Ir = (e, t) => ('blob' !== t ? (e instanceof ArrayBuffer ? e : e.buffer) : e instanceof Blob ? e : new Blob([e])),
    ...
    transform(e, t) {
      !(function (e, t) {
        Sr && e.data instanceof Blob
          ? e.data.arrayBuffer().then(Er).then(t)
          : Ar && (e.data instanceof ArrayBuffer || $r(e.data))
            ? t(Er(e.data))
            : Pr(e, !1, (e) => {
                (Br = Br || new TextEncoder()), t(Br.encode(e));
              });
      })(e, (r) => {
        var o,
          s = r.length;
        ...
        s < 126
          ...
          : s < 65536
            ? ((n = new Uint8Array(3)), (o = new DataView(n.buffer)).setUint8(0, 126), o.setUint16(1, s))
            : ((n = new Uint8Array(9)), (o = new DataView(n.buffer)).setUint8(0, 127), o.setBigUint64(1, BigInt(s))),
...
function Dr(e, t) {
  ...
  let o = 0;
  for (let s = 0; s < t; s++) (r[s] = e[0][o++]), o === e[0].length && (e.shift(), (o = 0));
  return e.length && o < e[0].length && (e[0] = e[0].slice(o)), r;
}
function Fr(e) {
  if (e)
    return (function (e) {
      for (var t in Fr.prototype) e[t] = Fr.prototype[t];
      return e;
    })(e);
}
(Fr.prototype.on = Fr.prototype.addEventListener =
  function (e, t) {
  ...
  (Fr.prototype.off =
    Fr.prototype.removeListener =
    Fr.prototype.removeAllListeners =
    Fr.prototype.removeEventListener =
      function (e, t) {
  ...
  (Fr.prototype.emit = function (e) {
    ...
    for (var t = new Array(arguments.length - 1), r = this._callbacks['$' + e], o = 1; o < arguments.length; o++) t[o - 1] = arguments[o];
    if (r) {
      o = 0;
      for (var s = (r = r.slice(0)).length; o < s; ++o) r[o].apply(this, t);
    }
    return this;
  }),
  (Fr.prototype.emitReserved = Fr.prototype.emit),
  (Fr.prototype.listeners = function (e) {
    return (this._callbacks = this._callbacks || {}), this._callbacks['$' + e] || [];
  }),
  (Fr.prototype.hasListeners = function (e) {
    return !!this.listeners(e).length;
  });
const Hr = 'undefined' != typeof self ? self : 'undefined' != typeof window ? window : Function('return this')();
function Wr(e, ...t) {
  return t.reduce((t, r) => (e.hasOwnProperty(r) && (t[r] = e[r]), t), {});
}
const Gr = Hr.setTimeout,
  Vr = Hr.clearTimeout;
function Yr(e, t) {
  t.useNativeTimers
    ? ((e.setTimeoutFn = Gr.bind(Hr)), (e.clearTimeoutFn = Vr.bind(Hr)))
    : ((e.setTimeoutFn = Hr.setTimeout.bind(Hr)), (e.clearTimeoutFn = Hr.clearTimeout.bind(Hr)));
}
function Xr(e) {
  return 'string' == typeof e
    ? (function (e) {
        ...
        for (let o = 0, s = e.length; o < s; o++)
          (t = e.charCodeAt(o)) < 128 ? (r += 1) : t < 2048 ? (r += 2) : t < 55296 || 57344 <= t ? (r += 3) : (o++, (r += 4));
        return r;
      })(e)
...
class Kr extends Fr {
  constructor(e) {
    super(), (this.writable = !1), Yr(this, e), (this.opts = e), (this.query = e.query), (this.socket = e.socket);
  }
  onError(e, t, r) {
    return super.emitReserved('error', new Jr(e, t, r)), this;
  }
  open() {
  ...
  onData(e) {
    (e = jr(e, this.socket.binaryType)), this.onPacket(e);
  }
  onPacket(e) {
...
const Qr = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_'.split(''),
  Zr = 64,
  eo = {};
let to,
  ro = 0,
...
function so(e) {
  let t = '';
  for (; (t = Qr[e % Zr] + t), 0 < (e = Math.floor(e / Zr)); );
  return t;
}
function no() {
  var e = so(+new Date());
  return e !== to ? ((ro = 0), (to = e)) : e + '.' + so(ro++);
}
for (; oo < Zr; oo++) eo[Qr[oo]] = oo;
let io = !1;
try {
  io = 'undefined' != typeof XMLHttpRequest && 'withCredentials' in new XMLHttpRequest();
} catch (Mt) {}
const ao = io;
function lo(e) {
  e = e.xdomain;
  try {
    if ('undefined' != typeof XMLHttpRequest && (!e || ao)) return new XMLHttpRequest();
  } catch (e) {}
  if (!e)
    try {
      return new Hr[['Active'].concat('Object').join('X')]('Microsoft.XMLHTTP');
    } catch (e) {}
}
function co() {}
const ho = null != new lo({ xdomain: !1 }).responseType;
class po extends Fr {
  constructor(e, t) {
    super(),
      Yr(this, t),
  ...
  create() {
    var e,
      t = Wr(this.opts, 'agent', 'pfx', 'key', 'passphrase', 'cert', 'ca', 'ciphers', 'rejectUnauthorized', 'autoUnref');
    t.xdomain = !!this.opts.xd;
    const r = (this.xhr = new lo(t));
    try {
      ...
      null != (e = this.opts.cookieJar) && e.addCookies(r),
        ...
        (r.onreadystatechange = () => {
          var e;
          3 === r.readyState && null != (e = this.opts.cookieJar) && e.parseCookies(r),
            4 === r.readyState &&
    ...
    'undefined' != typeof document && ((this.index = po.requestsCount++), (po.requests[this.index] = this));
  }
  onError(e) {
  ...
  cleanup(e) {
    if (void 0 !== this.xhr && null !== this.xhr) {
      if (((this.xhr.onreadystatechange = co), e))
        try {
          this.xhr.abort();
        } catch (e) {}
      'undefined' != typeof document && delete po.requests[this.index], (this.xhr = null);
    }
  }
  onLoad() {
...
if (((po.requestsCount = 0), (po.requests = {}), 'undefined' != typeof document))
  if ('function' == typeof attachEvent) attachEvent('onunload', uo);
  else if ('function' == typeof addEventListener) {
    addEventListener('onpagehide' in Hr ? 'pagehide' : 'unload', uo, !1);
  }
function uo() {
  for (var e in po.requests) po.requests.hasOwnProperty(e) && po.requests[e].abort();
}
const fo = 'function' == typeof Promise && 'function' == typeof Promise.resolve ? (e) => Promise.resolve().then(e) : (e, t) => t(e, 0),
  go = Hr.WebSocket || Hr.MozWebSocket,
  bo = 'undefined' != typeof navigator && 'string' == typeof navigator.product && 'reactnative' === navigator.product.toLowerCase();
const wo = {
    websocket: class extends Kr {
      constructor(e) {
      ...
      doOpen() {
        if (this.check()) {
          ...
          try {
            this.ws = bo ? new go(e, t, r) : t ? new go(e, t) : new go(e);
          } catch (e) {
      ...
      uri() {
        var e = this.opts.secure ? 'wss' : 'ws',
          t = this.query || {};
        return this.opts.timestampRequests && (t[this.opts.timestampParam] = no()), this.supportsBinary || (t.b64 = 1), this.createUri(e, t);
      }
      check() {
        return !!go;
      }
    },
    webtransport: class extends Kr {
      get name() {
        return 'webtransport';
      }
      doOpen() {
        'function' == typeof WebTransport &&
          ...
          this.transport.ready.then(() => {
            this.transport.createBidirectionalStream().then((e) => {
                  ...
                  transform(i, a) {
                    for (r.push(i); ; ) {
                      if (0 === o) {
                        if (qr(r) < 1) break;
                        var l = Dr(r, 1);
                        (n = 128 == (128 & l[0])), (s = 127 & l[0]), (o = s < 126 ? 3 : 126 === s ? 1 : 2);
                      } else if (1 === o) {
                        if (qr(r) < 2) break;
                        (l = Dr(r, 2)), (s = new DataView(l.buffer, l.byteOffset, l.length).getUint16(0)), (o = 3);
                      } else if (2 === o) {
                        if (qr(r) < 8) break;
                        var c = Dr(r, 8),
                        ...
                        (s = h * Math.pow(2, 32) + c.getUint32(4)), (o = 3);
                      } else {
                        if (qr(r) < s) break;
                        (h = Dr(r, s)), a.enqueue(jr(n ? h : Ur.decode(h), t)), (o = 0);
                      }
                      if (0 === s || s > e) {
                        a.enqueue(Cr);
                        break;
              ...
              (t = Mr()).readable.pipeTo(e.writable), (this.writer = t.writable.getWriter());
              const o = () => {
                r.read()
                  .then(({ done: e, value: t }) => {
                    e || (this.onPacket(t), o());
              ...
              o(), (e = { type: 'open' }), this.query.sid && (e.data = `{"sid":"${this.query.sid}"}`), this.writer.write(e).then(() => this.onOpen());
            });
          }));
      }
      write(e) {
    ...
    polling: class extends Kr {
      constructor(e) {
        ...
        (t = e && e.forceBase64), (this.supportsBinary = ho && !t), this.opts.withCredentials && (this.cookieJar = void 0);
      }
      get name() {
        return 'polling';
      }
      ...
      onData(e) {
        ((e, t) => {
          ...
          for (let e = 0; e < r.length; e++) {
            var s = jr(r[e], t);
            if ((o.push(s), 'error' === s.type)) break;
          }
          return o;
      ...
      uri() {
        var e = this.opts.secure ? 'https' : 'http',
          t = this.query || {};
        return (
          !1 !== this.opts.timestampRequests && (t[this.opts.timestampParam] = no()),
          this.supportsBinary || t.sid || (t.b64 = 1),
          this.createUri(e, t)
        );
      }
      request(e = {}) {
        return Object.assign(e, { xd: this.xd, cookieJar: this.cookieJar }, this.opts), new po(this.uri(), e);
      }
      doWrite(e, t) {
...
let xo = class e extends Fr {
  constructor(e, t = {}) {
    super(),
      ...
      e
        ...
        : t.host && (t.hostname = vo(t.host).host),
      Yr(this, t),
  ...
  probe(t) {
        ...
        r.once('packet', (t) => {
          o ||
            ('pong' === t.type && 'probe' === t.data
              ...
              : (((t = new Error('probe error')).transport = r.name), this.emitReserved('upgradeError', t)));
        }));
    };
    function n() {
      o || ((o = !0), h(), r.close(), (r = null));
    }
    const i = (e) => {
      ((e = new Error('probe error: ' + e)).transport = r.name), n(), this.emitReserved('upgradeError', e);
    };
    function a() {
      i('transport closed');
    }
    ...
    const h = () => {
      r.removeListener('open', s), r.removeListener('error', i), r.removeListener('close', a), this.off('close', l), this.off('upgrading', c);
    };
    r.once('open', s),
      r.once('error', i),
      r.once('close', a),
  ...
  onOpen() {
    if (
      ...
      let e = 0;
      for (var t = this.upgrades.length; e < t; e++) this.probe(this.upgrades[e]);
    }
  }
  onPacket(e) {
  ...
  getWritablePackets() {
    if (this.maxPayload && 'polling' === this.transport.name && 1 < this.writeBuffer.length) {
      ...
      for (let r = 0; r < this.writeBuffer.length; r++) {
        ...
        if ((e && (t += Xr(e)), 0 < r && t > this.maxPayload)) return this.writeBuffer.slice(0, r);
        t += 2;
      }
    }
  ...
  sendPacket(e, t, r, o) {
    'function' == typeof t && ((o = t), (t = void 0)),
      ...
      'closing' !== this.readyState &&
        ...
        this.emitReserved('packetCreate', (e = { type: e, data: t, options: r })),
  ...
  onError(t) {
    (e.priorWebsocketSuccess = !1), this.emitReserved('error', t), this.onClose('transport error', t);
  }
  onClose(e, t) {
  ...
  filterUpgrades(e) {
    var t = [];
    let r = 0;
    for (var o = e.length; r < o; r++) ~this.transports.indexOf(e[r]) && t.push(e[r]);
    return t;
  }
};
xo.protocol = 4;
const ko = 'function' == typeof ArrayBuffer,
  _o = (e) => ('function' == typeof ArrayBuffer.isView ? ArrayBuffer.isView(e) : e.buffer instanceof ArrayBuffer),
  Co = Object.prototype.toString,
  So = 'function' == typeof Blob || ('undefined' != typeof Blob && '[object BlobConstructor]' === Co.call(Blob)),
  Ao = 'function' == typeof File || ('undefined' != typeof File && '[object FileConstructor]' === Co.call(File));
function $o(e) {
  return (ko && (e instanceof ArrayBuffer || _o(e))) || (So && e instanceof Blob) || (Ao && e instanceof File);
}
function Po(e, t) {
  if (e && 'object' == typeof e)
    if (Array.isArray(e)) {
      for (let t = 0, r = e.length; t < r; t++) if (Po(e[t])) return !0;
    } else {
      if ($o(e)) return !0;
      if (e.toJSON && 'function' == typeof e.toJSON && 1 === arguments.length) return Po(e.toJSON(), !0);
      for (const t in e) if (Object.prototype.hasOwnProperty.call(e, t) && Po(e[t])) return !0;
    }
  return !1;
}
function To(e) {
  var t = [],
    r = e.data;
  return (e.data = Eo(r, t)), (e.attachments = t.length), { packet: e, buffers: t };
}
function Eo(e, t) {
  if (!e) return e;
  var r;
  if ($o(e)) return (r = { _placeholder: !0, num: t.length }), t.push(e), r;
  if (Array.isArray(e)) {
    var o = new Array(e.length);
    for (let r = 0; r < e.length; r++) o[r] = Eo(e[r], t);
    return o;
  }
  if ('object' != typeof e || e instanceof Date) return e;
  var s = {};
  for (const r in e) Object.prototype.hasOwnProperty.call(e, r) && (s[r] = Eo(e[r], t));
  return s;
}
function Bo(e, t) {
...
function Ro(e, t) {
  if (e) {
    if (e && !0 === e._placeholder) {
      if ('number' == typeof e.num && 0 <= e.num && e.num < t.length) return t[e.num];
      throw new Error('illegal attachments');
    }
    if (Array.isArray(e)) for (let r = 0; r < e.length; r++) e[r] = Ro(e[r], t);
    else if ('object' == typeof e) for (const r in e) Object.prototype.hasOwnProperty.call(e, r) && (e[r] = Ro(e[r], t));
  }
  return e;
}
const Oo = ['connect', 'connect_error', 'disconnect', 'disconnecting', 'newListener', 'removeListener'];
!(function (e) {
...
class jo extends Fr {
  ...
  add(e) {
    ...
    if ('string' == typeof e) {
      ...
      ((!r && t.type !== Oe.BINARY_ACK) || ((t.type = r ? Oe.EVENT : Oe.ACK), (this.reconstructor = new zo(t)), 0 === t.attachments)) &&
        super.emitReserved('decoded', t);
    } else {
      if (!$o(e) && !e.base64) throw new Error('Unknown type: ' + e);
      if (!this.reconstructor) throw new Error('got binary data when not reconstructing a packet');
      (t = this.reconstructor.takeBinaryData(e)) && ((this.reconstructor = null), super.emitReserved('decoded', t));
    }
  }
  decodeString(e) {
    let t = 0;
    ...
    if (r.type === Oe.BINARY_EVENT || r.type === Oe.BINARY_ACK) {
      ...
      if ((o = e.substring(o, t)) != Number(o) || '-' !== e.charAt(t)) throw new Error('Illegal attachments');
      r.attachments = Number(o);
    }
    if ('/' === e.charAt(t + 1)) {
      for (o = t + 1; ++t && ',' !== e.charAt(t) && t !== e.length; );
      r.nsp = e.substring(o, t);
    } else r.nsp = '/';
    if ('' !== (o = e.charAt(t + 1)) && Number(o) == o) {
      for (o = t + 1; ++t; ) {
        var s = e.charAt(t);
    ...
    if (e.charAt(++t)) {
      if (((o = this.tryParse(e.substr(t))), !jo.isPayloadValid(r.type, o))) throw new Error('invalid payload');
      r.data = o;
    }
    return r;
  }
  ...
  static isPayloadValid(e, t) {
    switch (e) {
      ...
      case Oe.CONNECT_ERROR:
        return 'string' == typeof t || Lo(t);
      case Oe.EVENT:
      case Oe.BINARY_EVENT:
        return Array.isArray(t) && ('number' == typeof t[0] || ('string' == typeof t[0] && -1 === Oo.indexOf(t[0])));
      case Oe.ACK:
      case Oe.BINARY_ACK:
...
class zo {
  ...
  takeBinaryData(e) {
    return (
      this.buffers.push(e),
      this.buffers.length === this.reconPack.attachments ? ((e = Bo(this.reconPack, this.buffers)), this.finishedReconstruction(), e) : null
    );
  }
...
var Io = Object.freeze({
  ...
  Encoder: class {
    ...
    encode(e) {
      return (e.type !== Oe.EVENT && e.type !== Oe.ACK) || !Po(e)
        ? [this.encodeAsString(e)]
        : this.encodeAsBinary({ type: e.type === Oe.EVENT ? Oe.BINARY_EVENT : Oe.BINARY_ACK, nsp: e.nsp, data: e.data, id: e.id });
    }
    encodeAsString(e) {
      let t = '' + e.type;
      return (
        (e.type !== Oe.BINARY_EVENT && e.type !== Oe.BINARY_ACK) || (t += e.attachments + '-'),
        e.nsp && '/' !== e.nsp && (t += e.nsp + ','),
        null != e.id && (t += e.id),
...
const Mo = Object.freeze({ connect: 1, connect_error: 1, disconnect: 1, disconnecting: 1, newListener: 1, removeListener: 1 });
class Uo extends Fr {
  constructor(e, t, r) {
    super(),
      (this.connected = !1),
  ...
  emit(e, ...t) {
    if (Mo.hasOwnProperty(e)) throw new Error('"' + e.toString() + '" is a reserved event name');
    var r, o;
    return (
      t.unshift(e),
      !this._opts.retries || this.flags.fromQueue || this.flags.volatile
        ? (((e = { type: Oe.EVENT, data: t, options: {} }).options.compress = !1 !== this.flags.compress),
          'function' == typeof t[t.length - 1] && ((r = this.ids++), (o = t.pop()), this._registerAckCallback(r, o), (e.id = r)),
          (o = this.io.engine && this.io.engine.transport && this.io.engine.transport.writable),
          (!this.flags.volatile || (o && this.connected)) &&
            (this.connected ? (this.notifyOutgoingListeners(e), this.packet(e)) : this.sendBuffer.push(e)),
          (this.flags = {}))
        : this._addToQueue(t),
      this
    );
  ...
  emitWithAck(e, ...t) {
    ...
    return new Promise((o, s) => {
      t.push((e, t) => (r ? (e ? s(e) : o(t)) : o(e))), this.emit(e, ...t);
    });
  }
  _addToQueue(e) {
    let t;
    ...
    e.push((e, ...o) => {
      if (r === this._queue[0])
        return (
          null !== e ? r.tryCount > this._opts.retries && (this._queue.shift(), t) && t(e) : (this._queue.shift(), t && t(null, ...o)),
          (r.pending = !1),
          this._drainQueue()
        );
    }),
  ...
  _sendConnectPacket(e) {
    this.packet({ type: Oe.CONNECT, data: this._pid ? Object.assign({ pid: this._pid, offset: this._lastOffset }, e) : e });
  }
  onerror(e) {
  ...
  emitEvent(e) {
    if (this._anyListeners && this._anyListeners.length) for (const t of this._anyListeners.slice()) t.apply(this, e);
  ...
  ack(e) {
    ...
    let r = !1;
    return function (...o) {
      r || ((r = !0), t.packet({ type: Oe.ACK, id: e, data: o }));
    };
  }
  onack(e) {
  ...
  notifyOutgoingListeners(e) {
    if (this._anyOutgoingListeners && this._anyOutgoingListeners.length) for (const t of this._anyOutgoingListeners.slice()) t.apply(this, e.data);
  }
}
function qo(e) {
  (this.ms = (e = e || {}).min || 100),
...
(qo.prototype.duration = function () {
  ...
  return (
    this.jitter && ((e = Math.random()), (t = Math.floor(e * this.jitter * r)), (r = 0 == (1 & Math.floor(10 * e)) ? r - t : r + t)),
...
class Do extends Fr {
  constructor(e, t) {
    super(),
      ...
      (this.backoff = new qo({ min: this.reconnectionDelay(), max: this.reconnectionDelayMax(), jitter: this.randomizationFactor() })),
  ...
  socket(e, t) {
    let r = this.nsps[e];
    return r ? this._autoConnect && !r.active && r.connect() : ((r = new Uo(this, e, t)), (this.nsps[e] = r)), r;
  }
  _destroy(e) {
  ...
  reconnect() {
    ...
    if (this.backoff.attempts >= this._reconnectionAttempts) this.backoff.reset(), this.emitReserved('reconnect_failed'), (this._reconnecting = !1);
      ...
      const r = this.setTimeoutFn(() => {
        e.skipReconnect ||
          (this.emitReserved('reconnect_attempt', e.backoff.attempts), e.skipReconnect) ||
          e.open((t) => {
...
function Ho(e, t) {
  ...
  e = (function (e, t = '', r) {
    ...
    return (
      ...
      (o.path = o.path || '/'),
      (e = -1 !== o.host.indexOf(':') ? '[' + o.host + ']' : o.host),
      (o.id = o.protocol + '://' + e + ':' + o.port + t),
      (o.href = o.protocol + '://' + e + (r && r.port === o.port ? '' : ':' + o.port)),
      o
    );
  ...
  var r = e.source,
    o = e.id,
    s = e.path;
  s = Fo[o] && s in Fo[o].nsps;
  let n;
  return (
    (n = (s = t.forceNew || t['force new connection'] || !1 === t.multiplex || s) ? new Do(r, t) : (Fo[o] || (Fo[o] = new Do(r, t)), Fo[o])),
    e.query && !t.query && (t.query = e.queryKey),
    n.socket(e.path, t)
  );
}
Object.assign(Ho, { Manager: Do, Socket: Uo, io: Ho, connect: Ho });
const Wo = oe('<style>'),
  Go = oe(
...
const Yo = (e) => {
    ...
    const [r] = V(e, ['onOpen', 'onClose', 'isOpen', 'value']),
        ...
        (A(() => {
          t &&
            (t.innerHTML = (function (e) {
              return (e = (e = 'string' != typeof e ? JSON.stringify(e, void 0, 2) : e)
                .replace(/&/g, '&amp;')
                .replace(/</g, '&lt;')
                .replace(/>/g, '&gt;')).replace(
                ...
                function (e) {
                  let t = 'number';
                  return (
                    /^"/.test(e) ? (t = /:$/.test(e) ? 'key' : 'string') : /true|false/.test(e) ? (t = 'boolean') : /null/.test(e) && (t = 'null'),
                    '<span class="' + t + '">' + e + '</span>'
                  );
                },
              );
      ...
      a = () => {
        o() ? i() : (s(!0), r.onOpen?.(), (document.body.style.overflow = 'hidden'));
      };
    return D(X, {
      get when() {
        return o();
      ...
      get children() {
        return [
          ...
          ((s = Go()),
          (r = s.firstChild),
          (o = r.nextSibling.nextSibling.firstChild.firstChild),
          s.style.setProperty('z-index', '1100'),
          s.addEventListener('click', i),
          ce(r, ve),
          o.style.setProperty('background-color', 'transparent'),
          o.style.setProperty('margin-left', '20px'),
          o.style.setProperty('margin-right', '20px'),
            ...
            (() => {
              ...
              return () => {
                return (
                  ...
                  'function' == typeof (s = t) ? le(s, o) : (t = o),
                  e)
                );
              };
            })(),
...
function ts(e, t, r) {
  ss.start()
            ...
            (es = setInterval(() => {
              (Qo = (function (e) {
                ...
                var t = ((e /= 1e3), Math.floor(e % 60)),
                  ...
                  o = (e = Math.floor(e / 60)) % 24;
                (e = e = Math.floor(e / 24)), (o += 24 * e);
                return 0 == o ? os(r, 2) + ':' + os(t, 2) : os(o, 2) + ':' + os(r, 2) + ':' + os(t, 2);
              })(Ko)),
                e(Qo),
                (function () {
                  var e = Qo.split(':'),
    ...
    .catch((e) => {
      switch (
        (e.message.includes('mediaDevices API or getUserMedia method is not supported in this browser.') && t && t(!0), console.log(e), e.name)
      ) {
        case 'AbortError':
...
const ss = {
    ...
    start: function () {
      return navigator.mediaDevices && navigator.mediaDevices.getUserMedia
        ? navigator.mediaDevices.getUserMedia({ audio: !0 }).then((e) => {
            (ss.streamBeingCaptured = e),
              (ss.mediaRecorder = new MediaRecorder(e)),
              (ss.audioBlobs = []),
              ss.mediaRecorder.addEventListener('dataavailable', (e) => {
                ss.audioBlobs.push(e.data);
              }),
              ss.mediaRecorder.start();
          })
        : Promise.reject(new Error('mediaDevices API or getUserMedia method is not supported in this browser.'));
    },
    stop: function () {
      return new Promise((e) => {
        const t = ss.mediaRecorder?.mimeType;
        ss.mediaRecorder?.addEventListener('stop', () => {
          var r = new Blob(ss.audioBlobs, { type: t });
          e(r);
        }),
          ss.cancel();
      });
    ...
    cancel: function () {
      ss.mediaRecorder?.stop(), ss.stopStream(), ss.resetRecordingProperties();
    },
    stopStream: function () {
      ss.streamBeingCaptured?.getTracks().forEach((e) => e.stop());
    },
    resetRecordingProperties: function () {
      (ss.mediaRecorder = null), (ss.streamBeingCaptured = null);
    },
  },
  ns = oe('<div class="w-full flex flex-row flex-wrap px-5 py-[10px] gap-2">'),
  is = oe('<div class="w-full flex items-center justify-start gap-2 px-5 pt-2 border-t border-[#eeeeee]">'),
  as = oe(
  ...
  ls = oe('<div class="absolute top-0 left-0 bottom-0 right-0 w-full h-full z-50">'),
  cs = oe(
  ...
  hs = oe('<span>'),
  ps = oe('<span>Max Allowed Size: <!> MB'),
  ds = oe('<div>'),
  us = oe('<span class="px-3 whitespace-pre-wrap font-semibold max-w-full">'),
  fs = oe('<span>Clear'),
  gs = oe('<div class="flex flex-row items-center w-full h-[50px] absolute top-0 left-0 z-10"><div>'),
  bs = oe(
  ...
  xs = oe('<span class="ml-1.5">Sending...'),
  ...
  _s = (e) => {
    ...
    const [s, n] = x(''),
      ...
      [l, c] = x(!1),
      [h, p] = x({}),
      [d, u] = x([{ message: t.welcomeMessage ?? ks, type: 'apiMessage' }], { equals: !1 }),
      [f, g] = x(''),
      [b, w] = x(!1),
      [m, y] = x(je()),
      [v, $] = x([], { equals: !1 }),
      ...
      W =
        (A(() => {
          if (e?.observersConfig) {
            const { observeUserInput: t, observeLoading: r, observeMessages: o } = e.observersConfig;
            'function' == typeof t &&
              C(() => {
                t(s());
              }),
      ...
      V = (e) => {
        localStorage.setItem(t.chatflowid + '_EXTERNAL', JSON.stringify({ chatId: m(), chatHistory: e }));
      },
      J = (e, t, r = null, o = null) => {
        u((s) => {
          var n = s.map((n, i) => (i === s.length - 1 ? { ...n, message: n.message + e, messageId: t, sourceDocuments: r, fileAnnotations: o } : n));
          return V(n), [...n];
        });
      },
      K = (e) => {
        u((t) => {
          var r = t.map((r, o) => (o === t.length - 1 ? { ...r, sourceDocuments: e } : r));
          return V(r), [...r];
        });
      },
      Q = (e) => {
      ...
      Z = async (e) => {
        if ((n(e), '' === e.trim())) {
          var r = 0 < R().filter((e) => 'audio' === e.type).length;
          if (!(1 <= R().length && r)) return;
        }
        a(!0), W();
        const o = t.welcomeMessage ?? ks;
        r = d().filter((e) => e.message !== o);
        const s = R().map((e) => ({ data: e.data, type: e.type, name: e.name, mime: e.mime }));
        R().forEach((e) => URL.revokeObjectURL(e.preview)),
          O([]),
          u((t) => ((t = [...t, { message: e, type: 'userMessage', fileUploads: s }]), V(t), t));
        (r = { question: e, history: r, chatId: m() }),
          s && 0 < s.length && (r.uploads = s),
          t.chatflowConfig && (r.overrideConfig = t.chatflowConfig),
          b() ? (r.socketIOClientId = f()) : u((e) => [...e, { message: '', type: 'apiMessage' }]),
          (r = await (({ chatflowid: e, apiHost: t = 'http://localhost:3000', body: r }) =>
            _e({ method: 'POST', url: t + '/api/v1/prediction/' + e, body: r }))({ chatflowid: t.chatflowid, apiHost: t.apiHost, body: r }));
        if (r.data) {
          var i = r.data;
          const t = i.question;
          if (
            ('' === e &&
              t &&
              u((e) => {
                var r = e.map((r, o) => (o === e.length - 2 ? { ...r, message: t } : r));
                return V(r), [...r];
              }),
            s &&
              0 < s.length &&
              u((e) => {
                var t = e.map((t, r) =>
                  r === e.length - 2 && t.fileUploads
                    ? ((r = t?.fileUploads.map((e) => ({ type: e.type, name: e.name, mime: e.mime }))), { ...t, fileUploads: r })
                    : t,
                );
                return V(t), [...t];
              }),
            ...
            J('', i?.chatMessageId, i?.sourceDocuments, i?.fileAnnotations);
          else {
            let e = '';
            (e = i.text || (i.json ? JSON.stringify(i.json, null, 2) : JSON.stringify(i, null, 2))),
              J(e, i?.chatMessageId, i?.sourceDocuments, i?.fileAnnotations);
          }
          a(!1), n(''), W();
        }
        r.error &&
          ...
          ((e = 'Oops! There seems to be an error. Please try again.') => {
            u((t) => ((t = [...t, { message: e, type: 'apiMessage' }]), V(t), t)), a(!1), n(''), W();
          })((r = 'string' == typeof i ? i : i.response.data || i.response.status + ': ' + i.response.statusText)));
      },
      ee = () => {
        try {
          localStorage.removeItem(t.chatflowid + '_EXTERNAL'), y(je()), u([{ message: t.welcomeMessage ?? ks, type: 'apiMessage' }]);
        } catch (t) {
        ...
        _(async () => {
          var e = ((e = localStorage.getItem(t.chatflowid + '_EXTERNAL')) &&
            ...
            (e = e.chatHistory.map((e) => {
              var t = { messageId: e?.messageId, message: e.message, type: e.type };
              return (
            ...
            u([...e])),
          await (({ chatflowid: e, apiHost: t = 'http://localhost:3000' }) => _e({ method: 'GET', url: t + '/api/v1/chatflows-streaming/' + e }))({
            chatflowid: t.chatflowid,
            apiHost: t.apiHost,
          })).data;
          e && w(e?.isStreaming ?? !1),
            (e = await (({ chatflowid: e, apiHost: t = 'http://localhost:3000' }) =>
              _e({ method: 'GET', url: t + '/api/v1/public-chatbotConfig/' + e }))({ chatflowid: t.chatflowid, apiHost: t.apiHost }));
          if (e.data) {
            const t = e.data;
            if (t.starterPrompts) {
              const e = [];
            ...
            t.chatFeedback && ((e = t.chatFeedback.status), T(e)), t.uploads && B(t.uploads);
          }
          const r = Ho(t.apiHost);
          return (
            r.on('connect', () => {
              g(r.id);
            }),
            r.on('start', () => {
              u((e) => [...e, { message: '', type: 'apiMessage' }]);
            }),
            r.on('sourceDocuments', K),
            r.on('token', J),
            () => {
              n(''), a(!1), u([{ message: t.welcomeMessage ?? ks, type: 'apiMessage' }]), r && (r.disconnect(), g(''));
            }
          );
        }),
        (e) => {
      ...
      re = (e) => {
        ...
        r.readAsDataURL(e),
          (r.onloadend = () => {
            const e = { data: r.result, preview: '../assets/wave-sound.jpg', type: 'audio', name: 'audio.wav', mime: t };
            O((t) => [...t, e]);
          });
      },
      oe = (e) => {
        let t = !1;
        if (E() && E()?.isImageUploadAllowed && E()?.imgUploadSizeAndTypes) {
          const r = e.type,
            o = e.size / 1024 / 1024;
          E()?.imgUploadSizeAndTypes.map((e) => {
            e.fileTypes.includes(r) && o <= e.maxUploadSize && (t = !0);
          });
        }
        return t || alert('Cannot upload file. Kindly check the allowed file types and maximum allowed size.'), t;
      },
      se = async (e) => {
        if ((e = e.target.files) && 0 !== e.length) {
          ...
          for (const r of e) {
            ...
            t.push(
              new Promise((t) => {
                (e.onload = (e) => {
                  e?.target?.result && ((e = e.target.result), t({ data: e, preview: URL.createObjectURL(r), type: 'file', name: o, mime: r.type }));
                }),
                  e.readAsDataURL(r);
              }),
            );
      ...
      ae = (e) => {
        E()?.isImageUploadAllowed &&
          (e.preventDefault(), e.stopPropagation(), 'dragenter' === e.type || 'dragover' === e.type ? H(!0) : 'dragleave' === e.type && H(!1));
      },
      he = async (e) => {
        if (E()?.isImageUploadAllowed) {
                ...
                new Promise((t) => {
                  (e.onload = (e) => {
                    if (e?.target?.result) {
                      let s;
                      (e = e.target.result),
                        r.type.startsWith('audio/') ? (s = '../assets/wave-sound.jpg') : r.type.startsWith('image/') && (s = URL.createObjectURL(r)),
                        t({ data: e, preview: s, type: 'file', name: o, mime: r.type });
                    }
                  }),
                    e.readAsDataURL(r);
                }),
          ...
          if (e.dataTransfer && e.dataTransfer.items)
            for (const t of e.dataTransfer.items)
              'string' === t.kind && t.type.match('^text/uri-list')
                ? t.getAsString((e) => {
                    const t = { data: e, preview: e, type: 'url', name: e.substring(e.lastIndexOf('/') + 1), mime: '' };
                    O((e) => [...e, t]);
                  })
                : 'string' === t.kind &&
                  ...
                  t.getAsString((e) => {
                    if (-1 !== e.indexOf('href')) {
                      const t = {
                        data: (e = (e = e.substring(e.indexOf('href') + 6)).substring(0, e.indexOf('"'))),
                        preview: e,
                        type: 'url',
      ...
      pe = (e) => {
        'file' === e.type && URL.revokeObjectURL(e.preview), O(R().filter((t) => t !== e));
      },
      de = () => {
        I(!0), ts(I, M, j);
      },
      ue = () => {
        N || (ss.cancel(), clearInterval(es)), I(!1), M(!1);
      },
      fe = async () => {
        q(!0), rs(re);
      };
      ...
      _(
        (function (e, t, r) {
          ...
          return (r) => {
            ...
            var a;
            if (!n) return (a = S(() => t(i, s, r))), (s = i), a;
            n = !1;
          };
        })(R, (e) => {
          var t = 0 < e.filter((e) => 'audio' === e.type).length;
          return (
            1 <= e.length && t && (I(!1), M(!1), Q('')),
            () => {
              O([]);
            }
          );
      ...
      [
        (() => {
          const n = as(),
            ...
            l = a.firstChild,
            h = l.nextSibling;
          n.addEventListener('dragenter', ae);
          var u =
            ('function' == typeof (u = o) ? le(u, n) : (o = n),
            ce(
              n,
              (() => {
                const e = C(() => !!F());
                return () => {
                  return (
                    e() &&
                    ((t = ls()).addEventListener('drop', he),
                    t.addEventListener('dragover', ae),
                    t.addEventListener('dragend', ae),
                    t.addEventListener('dragleave', ae),
                    t.addEventListener('dragenter', ae),
                    t)
                  );
                };
              })(),
            ...
            ce(
              n,
              (() => {
                const e = C(() => !(!F() || !E()?.isImageUploadAllowed));
                return () =>
                  e() &&
                  (() => {
                    const e = cs();
                    return (
                      ...
                      ce(
                        ...
                        D(Y, {
                          get each() {
                            return E()?.imgUploadSizeAndTypes;
                          },
                          children: (e) => {
                            return [
                              (ce((r = hs()), () => e.fileTypes?.join(', ')), r),
                              ((r = ps()), (t = r.firstChild.nextSibling).nextSibling, ce(r, () => e.maxUploadSize, t), r),
                            ];
                          },
                        }),
                        null,
                      ...
                      k(() =>
                        null != t.bubbleBackgroundColor
                          ? e.style.setProperty('border-color', t.bubbleBackgroundColor)
                    ...
                    return (
                      ce(
                        ...
                        D(X, {
                          ...
                          get children() {
                            return [
                              ((e = ds()).style.setProperty('width', '15px'), e),
                              D(Et, {
                                get initialAvatarSrc() {
                                  return t.titleAvatarSrc;
                                },
                      ...
                      k(
                        (r) => {
                          var o = t.bubbleBackgroundColor,
                            s = t.bubbleTextColor,
                            n = t.isFullPage ? '0px' : '6px',
                            i = t.isFullPage ? '0px' : '6px';
                          return (
                            o !== r._v$ && (null != (r._v$ = o) ? e.style.setProperty('background', o) : e.style.removeProperty('background')),
                            s !== r._v$2 && (null != (r._v$2 = s) ? e.style.setProperty('color', s) : e.style.removeProperty('color')),
                            n !== r._v$3 &&
                              (null != (r._v$3 = n)
                                ? e.style.setProperty('border-top-left-radius', n)
                                : e.style.removeProperty('border-top-left-radius')),
                            i !== r._v$4 &&
                              (null != (r._v$4 = i)
                                ? e.style.setProperty('border-top-right-radius', i)
                                : e.style.removeProperty('border-top-right-radius')),
                            r
                          );
                        },
          ...
          return (
            ...
            ce(
              ...
              D(Y, {
                ...
                children: (e, r) => [
                  ...
                  C(
                    (() => {
                      const t = C(() => !('userMessage' !== e.type || !i() || r() !== d().length - 1));
                      return () => t() && D(fr, {});
                    })(),
                  ),
                  C(
                    (() => {
                      const t = C(() => !('apiMessage' !== e.type || '' !== e.message || !i() || r() !== d().length - 1));
                      return () => t() && D(fr, {});
                    })(),
                  ),
                  C(
                    (() => {
                      ...
                      return () => {
                        return (
                          t() &&
                          ((r = ds()).style.setProperty('display', 'flex'),
                            ...
                            D(Y, {
                                  ...
                                  ...((e) => {
                                    ...
                                    return (
                                      e.sourceDocuments.forEach((e) => {
                                        te(e.metadata.source) && !t.includes(e.metadata.source)
                                          ? (t.push(e.metadata.source), r.push(e))
                                          : te(e.metadata.source) || r.push(e);
                                      }),
                                      r
                                    );
                                  })(e),
                              ...
                              children: (e) => {
                                ...
                                return D(br, {
                                  ...
                                  onSourceClick: () => {
                                    t ? window.open(e.metadata.source, '_blank') : (p(e), c(!0));
                                  },
                                });
                              },
                            }),
                      ...
                      return (
                        ce(
                          ...
                          D(Y, {
                            ...
                            children: (e) => D(mr, { prompt: e, onPromptClick: () => Q(e) }),
                          }),
                        ),
                        e
                      );
                    ...
                    ce(
                      ...
                      D(Y, {
                        ...
                        children: (t) =>
                          C(
                            (() => {
                              const o = C(() => !!t.mime.startsWith('image/'));
                              return () =>
                                (o()
                                  ? () => {
                                      const e = bs(),
                                        r = e.firstChild,
                                        o = r.nextSibling;
                                      return (e.$$click = () => pe(t)), ce(o, D(nt, {})), k(() => ne(r, 'src', t.data)), e;
                                    }
                                  : () => {
                                      const o = ws(),
                                        s = o.firstChild,
                                      ...
                                      return (
                                        (n.$$click = () => pe(t)),
                                        ce(n, D(nt, { color: 'white' })),
                                        k(
                                          (n) => {
                                            var i = `${r ? (e.isFullPage ? r?.offsetWidth / 4 : r?.offsetWidth / 2) : '200'}px`,
                                              a = t.data;
                                            return (
                                              i !== n._v$5 &&
                                                (null != (n._v$5 = i) ? o.style.setProperty('width', i) : o.style.removeProperty('width')),
                                              a !== n._v$6 && ne(s, 'src', (n._v$6 = a)),
                                              n
                                            );
                                          },
                  ...
                  e()
                    ? C(
                        (() => {
                          const e = C(() => !!N());
                          return () => {
                            if (e()) return ((r = ms()).firstChild.firstChild.nextSibling.$$click = () => ue()), r;
                            {
                              const e = vs(),
                                r = e.firstChild,
                                o = r.firstChild,
                              ...
                              return (
                                ...
                                k(
                                  (r) => {
                                    var o = t.textInput?.backgroundColor ?? '#ffffff',
                                      s = t.textInput?.textColor ?? '#303235';
                                    return (
                                      o !== r._v$7 &&
                                        (null != (r._v$7 = o)
                                          ? e.style.setProperty('background-color', o)
                                          : e.style.removeProperty('background-color')),
                                      s !== r._v$8 && (null != (r._v$8 = s) ? e.style.setProperty('color', s) : e.style.removeProperty('color')),
                                      r
                                    );
                                  },
            ...
            k(() =>
              ie(n, 'relative flex w-full h-full text-base overflow-hidden bg-cover bg-center flex-col items-center chatbot-container ' + t.class),
            ),
            n
          );
        })(),
      ...
      [
        ...
        (() => {
          ...
          return (
            ...
            o.style.setProperty('transform-origin', 'bottom right'),
            ...
            k(
              (s) => {
                var n = t.theme?.chatWindow?.height ? t.theme?.chatWindow?.height.toString() + 'px' : 'calc(100% - 100px)',
                  i = t.theme?.chatWindow?.width ? t.theme?.chatWindow?.width.toString() + 'px' : void 0,
                  ...
                  c =
                    ...
                    ('large' === e.theme?.button?.size ? ' bottom-24' : ' bottom-20');
                return (
                  n !== s._v$ && (null != (s._v$ = n) ? o.style.setProperty('height', n) : o.style.removeProperty('height')),
                  i !== s._v$2 && (null != (s._v$2 = i) ? o.style.setProperty('width', i) : o.style.removeProperty('width')),
                  a !== s._v$3 && (null != (s._v$3 = a) ? o.style.setProperty('transform', a) : o.style.removeProperty('transform')),
                  l !== s._v$4 && (null != (s._v$4 = l) ? o.style.setProperty('background-color', l) : o.style.removeProperty('background-color')),
                  c !== s._v$5 && ie(o, (s._v$5 = c)),
                  s
                );
              },
        ...
        D(X, {
          ...
          get children() {
            ...
            return (
              ...
              k(
                (r) => {
                  var o = e.theme?.chatWindow?.backgroundColor || '#ffffff',
                    s = e.theme?.chatWindow?.height ? e.theme?.chatWindow?.height.toString() + 'px' : '100vh',
                    n = e.theme?.chatWindow?.width ? e.theme?.chatWindow?.width.toString() + 'px' : '100%';
                  return (
                    o !== r._v$ && (null != (r._v$ = o) ? t.style.setProperty('background-color', o) : t.style.removeProperty('background-color')),
                    s !== r._v$2 && (null != (r._v$2 = s) ? t.style.setProperty('height', s) : t.style.removeProperty('height')),
                    n !== r._v$3 && (null != (r._v$3 = n) ? t.style.setProperty('width', n) : t.style.removeProperty('width')),
                    r
                  );
                },
                { _v$: void 0, _v$2: void 0, _v$3: void 0 },
...
const Bs = (e) => {
    Os();
    var t = e.id ? document.getElementById(e.id) : document.querySelector('flowise-fullchatbot');
    if (!t) throw new Error('<flowise-fullchatbot> element not found.');
    Object.assign(t, e), (Es = t);
  },
  Rs = (e) => {
    Os();
    var t = document.createElement('flowise-chatbot');
    Object.assign(t, e), document.body.appendChild(t), (Es = t);
  },
  Os = () => {
    Es?.remove();
  },
  Ls = ('undefined' != typeof window && (me('flowise-fullchatbot', ye, Ts), me('flowise-chatbot', ye, As)), { initFull: Bs, init: Rs, destroy: Os });
((e) => {
